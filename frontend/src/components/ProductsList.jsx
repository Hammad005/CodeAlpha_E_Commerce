...
const ProductsList = () => {
  ...
  return (
    <motion.div
      className="bg-gray-800 shadow-lg rounded-lg overflow-x-auto scrollbar-thin scrollbar-thumb-green-500 scrollbar-track-gray-800 max-w-4xl mx-auto"
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <div
                      ...
                      title={product.name} // Tooltip with full name
                    >
